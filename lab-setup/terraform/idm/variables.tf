variable "idm_instance_network_interfaces" {
...
variable "idm_instance_pool_name" {
  description = "Name of the libvirt pool"
  type        = string
  default     = "demo"
}

variable "idm_instance_cloud_user" {
